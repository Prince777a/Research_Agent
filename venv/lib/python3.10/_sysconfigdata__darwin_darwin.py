...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Volumes/Personal /Final year Project2/venv/bin',
 'BINLIBDEST': '/Volumes/Personal /Final year Project2/venv/lib/python3.10',
 ...
 'BLDSHARED': 'clang -bundle -undefined '
              ...
              ''
              ''
              '-Wl,-rpath,/Volumes/Personal /Final year Project2/venv/lib '
              '-L/Volumes/Personal /Final year Project2/venv/lib '
              ''
              ''
              ''
              ''
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fPIC   -O2  '
           '-isystem '
           '/Volumes/Personal /Final year Project2/venv/include '
           ''
           ''
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Volumes/Personal /Final year Project2/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      ''
                      ''
 ...
 'CONFIG_ARGS': "'--prefix=/Volumes/Personal /Final year Project2/venv'"
                "'--build=arm64-apple-darwin20.0.0'"
                "'--host=arm64-apple-darwin20.0.0''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/Volumes/Personal /Final year Project2/venv/share/zoneinfo:/Volumes/Personal /Final year Project2/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/Volumes/Personal /Final year Project2/venv/include'"
                "'--with-tcltk-libs=-L/Volumes/Personal /Final year Project2/venv/lib "
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Volumes/Personal /Final year Project2/venv/include'"
                "'PKG_CONFIG_PATH=/Volumes/Personal /Final year Project2/venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/Volumes/Personal /Final year Project2/venv/include',
 'CONFINCLUDEPY': '/Volumes/Personal /Final year Project2/venv/include/python3.10',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '-I/Volumes/Personal /Final year Project2/venv/include',
 'CXX': 'clang++',
 'DESTDIRS': '/Volumes/Personal /Final year Project2/venv '
             '/Volumes/Personal /Final year Project2/venv/lib '
             '/Volumes/Personal /Final year Project2/venv/lib/python3.10 '
             '/Volumes/Personal /Final year Project2/venv/lib/python3.10/lib-dynload',
 'DESTLIB': '/Volumes/Personal /Final year Project2/venv/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/Volumes/Personal /Final year Project2/venv/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Volumes/Personal /Final year Project2/venv/include '
                   '/Volumes/Personal /Final year Project2/venv/include '
                   '/Volumes/Personal /Final year Project2/venv/include/python3.10 '
                   '/Volumes/Personal /Final year Project2/venv/include/python3.10',
 'INCLUDEDIR': '/Volumes/Personal /Final year Project2/venv/include',
 'INCLUDEPY': '/Volumes/Personal /Final year Project2/venv/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/Volumes/Personal /Final year Project2/venv/lib/python3.10',
 'LIBDIR': '/Volumes/Personal /Final year Project2/venv/lib',
 'LIBFFI_INCLUDEDIR': '/Volumes/Personal /Final year Project2/venv/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Volumes/Personal /Final year Project2/venv/lib/pkgconfig',
 'LIBPL': '/Volumes/Personal /Final year Project2/venv/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Volumes/Personal /Final year Project2/venv/lib/python3.10',
 ...
 'MANDIR': '/Volumes/Personal /Final year Project2/venv/share/man',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Volumes/Personal /Final year Project2/venv/include',
 'OPENSSL_LDFLAGS': '-L/Volumes/Personal /Final year Project2/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Volumes/Personal /Final year Project2/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/Volumes/Personal /Final year Project2/venv/include',
 'TCLTK_LIBS': '-L/Volumes/Personal /Final year Project2/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Volumes/Personal /Final year Project2/venv/share/zoneinfo:/Volumes/Personal /Final year Project2/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/Volumes/Personal /Final year Project2/venv/share',
 'exec_prefix': '/Volumes/Personal /Final year Project2/venv',
 'prefix': '/Volumes/Personal /Final year Project2/venv',
